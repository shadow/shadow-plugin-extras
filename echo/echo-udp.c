...
static EchoClient* _echoudp_newClient(EchoLogFunc log, in_addr_t serverIPAddress) {
	g_assert(log);
...
static EchoServer* _echoudp_newServer(EchoLogFunc log, in_addr_t bindIPAddress) {
	g_assert(log);
