...
static EchoClient* _echotcp_newClient(EchoLogFunc log, in_addr_t serverIPAddress) {
	g_assert(log);
...
static EchoServer* _echotcp_newServer(EchoLogFunc log, in_addr_t bindIPAddress) {
	g_assert(log);
...
static gboolean _echotcp_newPair(EchoLogFunc log, EchoClient** client, EchoServer** server) {
